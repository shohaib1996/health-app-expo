  ...
  return (
    <View className={cn('gap-1.5', className)}>
      ...
      <View className="rounded-default border border-neutral-700 px-3 py-3">
        <TextInput
          // RN has no native <label for> association — the visible
          // label above doesn't reach the input's accessible name on
          // its own, so it's passed through explicitly (G-9).
